<form action="" method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php _e('BuddyPress Account Page', 'uap');?></h3>
		<div class="inside">
			...
			<div class="row">
				<div class="col-xs-7">
					...
					<input type="checkbox" class="uap-switch" onClick="uap_check_and_h(this, '#uap_bp_account_page_enable');" <?php echo $checked;?> />
			...
			<div class="row">
				<div class="col-xs-7">
					...
					<input type="checkbox" class="uap-switch" onClick="uap_check_and_h(this, '#uap_bp_account_page_show_to_everyone');" <?php echo $checked;?> />
					<div class="switch" style="display:inline-block;"></div>
					</label>
