				...
				<div class="inside">
					...
					<div class="uap-form-line">
						...
						<label class="uap_label_shiwtch" style="margin:10px 0 10px -10px;">
							...
							<input type="checkbox" class="uap-switch" onClick="uap_check_and_h(this, '#uap_pay_to_become_affiliate_enabled');" <?php echo $checked;?> />
					...
					<div class="uap-form-line">
							...
							<div>
									...
									<label class="uap_label_shiwtch" style="margin:10px 0 10px -10px;">
										...
										<input type="checkbox" class="uap-switch" onClick="uap_check_and_h(this, '#uap_pay_to_become_affiliate_target_all_products');uap_make_disable_if_checked(this, '#reference_search');uap_reset_autocomplete_fields();" <?php echo $checked;?> />
										<div class="switch" style="display:inline-block;"></div>
									</label>
								...
								<div id="uap_reference_search_tags"><?php
									if (!empty($data['metas']['products'])){
										foreach ($data['metas']['products'] as $value){
											...
											?>
											<div id="<?php echo $id;?>" class="uap-tag-item"><?php echo $data['products']['label'][$value];?><div class="uap-remove-tag" onclick="uap_remove_tag('<?php echo $value;?>', '#<?php echo $id;?>', '#uap_pay_to_become_affiliate_target_products');" title="Removing tag">x</div></div>
											<?php
											}
										}
									}
